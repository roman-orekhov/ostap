...
let _ =
  ...
  List.iter 
    ...
    [doubleLookahead; identLookahead; identNotDigit; idents; ident; decim; letterOrDigit; testLookahead; identId; identDoubleBefore; identDigits; lettersDigitsBound; lettersDigits; lettersOrDigits]
;;